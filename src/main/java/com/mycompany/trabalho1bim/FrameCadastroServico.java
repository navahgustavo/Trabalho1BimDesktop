 ...
 */
public class FrameCadastroServico extends javax.swing.JFrame {

    private FrameMenu janela = new FrameMenu();
    private Arrays arrayServicos = new Arrays();
    
    public FrameCadastroServico() {
        initComponents();
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        servico.setId(arrayServicos.getServico().size());
